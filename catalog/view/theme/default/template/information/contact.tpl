					...
					<form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" class="form-horizontal">
						...
						<div class="buttons clearfix">
							<div class="pull-right">
								<button class="btn btn-hover btn-outline"><i class="fa fa-paper-plane"></i>   <?php echo $button_submit; ?></button>
								<!-- <input class="btn btn-hover btn-outline" type="submit" value='<i class="fa fa-paper-plane"></i><?php echo $button_submit; ?>' /> -->
							</div>
						</div>
					</form>
				</div>
