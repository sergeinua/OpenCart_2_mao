...
class ControllerShippingFlat1 extends Controller {
	...
	public function index() {
		$this->load->language('shipping/flat1');
		...
		$data['action'] = $this->url->link('shipping/flat1', 'token=' . $this->session->data['token'], 'SSL');
		...
		$this->response->setOutput($this->load->view('shipping/flat1.tpl', $data));
	}
