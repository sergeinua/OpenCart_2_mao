        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-banner" class="form-horizontal">
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-name"><?php echo $entry_href; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="href" value="<?php echo $href; ?>" placeholder="<?php echo $entry_href; ?>" id="input-name" class="form-control" />
                            <?php if ($error_name) { ?>
